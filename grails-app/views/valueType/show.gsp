	...
	<body>
		...
		<div id="show-valueType" class="content scaffold-show" role="main">
			...
			<ol class="property-list valueType">
				...
				<g:if test="${valueTypeInstance?.type}">
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="valueType.type.label" default="Type" /></span>
					
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${valueTypeInstance}" field="type"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${valueTypeInstance?.id}" />
					<g:link class="edit" action="edit" id="${valueTypeInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
